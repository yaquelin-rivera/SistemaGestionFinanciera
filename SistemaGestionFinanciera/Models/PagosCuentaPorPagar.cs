...
public partial class PagosCuentaPorPagar
{
    public int IdPagoCuentaPorPagar { get; set; }

    [Required(ErrorMessage = "Debe seleccionar una cuenta por pagar.")]
    ...
    public virtual CuentasPorPagar CuentaPorPagar { get; set; } = null!;
}